package com.example.capshop.service.product;
...
import com.example.capshop.domain.product.ProductStatus;
...
public class ProductService {
    ...
    public void updateStockBySize(Long productId, String size, Long stock) {
        ...
        com.example.capshop.domain.product.ProductStock productStock = product.getProductStockBySize(size);
        if (productStock == null) {
            productStock = new com.example.capshop.domain.product.ProductStock(product, size, stock);
